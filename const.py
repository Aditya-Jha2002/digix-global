...
class Const:
    ...
    INTERIM_TRAIN_DATA_FILE = 'train/train_data_file.json'
    INTERIM_TEST_DATA_FILE = 'test/test_data_file.json'
    ...
    FEEDS_SPARSE_FEATURE_NAME = ['u_phonePrice', 'u_browserLifeCycle', 'u_browserMode', 'u_feedLifeCycle_x', 'u_feedLifeCycle_y',
                                 'u_refreshTimes_x', 'u_refreshTimes_y']

    FEEDS_SEQUENCE_FEATURE_NAME = ['u_newsCatInterests', 'u_newsCatDislike', 'u_newsCatInterestsST_x', 'u_newsCatInterestsST_y', 'u_click_ca2_news']
